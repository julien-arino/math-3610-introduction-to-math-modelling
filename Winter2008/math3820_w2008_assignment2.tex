...
\author{Assignment 2}
\date{Due Thursday, March 6 2008}
...
\maketitle
\begin{abstract}
This assignment is due Thursday, March 6. Note that I will accept files, so if you want to typeset or scan your answers, this is fine (pdf is preferred).
...
\begin{itemize}
\item It is due on April 16, same day as the final for our class.
