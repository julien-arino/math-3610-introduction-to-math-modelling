...
\begin{center}
\includegraphics[width=.8\textwidth]{FigureMathBio}
\end{center}
...
with $c_1$ and $c_2$ arbitrary constants.
\begin{center}
\includegraphics[width=.5\textwidth]{FigurePhase}
\end{center}
...
\begin{center}
\begin{figure}
\includegraphics[width=1\textwidth]{LesliePattern}
...
\begin{center}
\includegraphics[width=.6\textwidth]{KillerWhales}
\end{center}
...
\end{description}
\begin{figure}
\includegraphics[width=.4\textwidth]{insect_life_cycle}
