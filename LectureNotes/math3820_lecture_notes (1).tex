...
\def\definesame#1{\textbf{#1}\index{#1}}
\def\define#1#2{\textbf{#1}\index{#2}}
...
%\input{math3820_course_description}
\part{A few introductory considerations}
\input{math3820_intro_modelling}
\input{math3820_matlab}
\input{math3820_logistic}
\input{math3820_residence_time}

\part{Deterministic discrete time systems} 
\input{math3820_discrete_time}
\input{math3820_leslie_matrix}

\part{Markov chains}
\input{math3820_markov}
\input{math3820_genetics}

\part{Ordinary differential equations}
\input{math3820_theory_ode}
\input{math3820_epidemic_models}
\input{math3820_chemostat}
\input{math3820_traffic_flow}

\part{Delay differential equations}
\input{math3820_dde}
\input{math3820_delay_traffic_flow}

\part{Partial differential equations}
\input{math3820_shallow_water}

\addcontentsline{toc}{part}{Appendices}
\appendix
\input{math3820_tools}
