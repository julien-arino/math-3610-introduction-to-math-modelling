...
A point $x^*$ in the domain of $f$ is said to be an \define{equilibrium point}{equilibrium point!difference equation} (an equilibrium solution) of the first-order difference equation \eqref{sys:discret_general} if it is a fixed point of $f$ \emph{i.e.} a constant solution that satisfies
$$f(x^*)=x^*.$$
\end{definition}
...
\begin{definition}
A \define{periodic solution}{periodic solution!difference equation} of (least) period $m>1$ of the difference equation \eqref{sys:discret_general} is a real-valued solution $\bar x_k$ satisfying
...
A equilibrium solution $\bar x$ of \eqref{sys:discret_general} is \define{locally stable}{local stability!difference equations} if, for any  $\varepsilon>0$, there exists $\delta>0$ such that if $\|x_0-\bar x\|<\delta$, then
\[
...
$$u_{t}=x_t-\bar x,$$
which represents a small quantity called a \define{perturbation}{perturbation!difference equations} of the equilibrium solution. Then $u_t$ satisfies the difference equation \eqref{sys:discret_general}
...
\begin{definition}
An equilibrium $\bar x$ of \eqref{sys:discret_general} is said to be \define{hyperbolic}{hyperbolic equilibrium point!difference equations} if $|f'(\bar x)|\not =1$.
Otherwise ($|f'(\bar x)| =1$), it is said to be \define{nonhyperbolic}{non hyperbolic equilibrium point!difference equations} .
\end{definition}
...
The \definesame{Schwarzian derivative} of a function $f$ at $x$ is denoted $(Sf)(x)$ and defined by
