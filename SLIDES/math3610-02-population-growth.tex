...
\title[Single population growth]{MATH 3610 -- 01 -- Single population growth models}
\author{\texorpdfstring{Julien Arino\newline University of Manitoba\newline\url{julien.arino@umanitoba.ca}}{Julien Arino}}
\date{}

\usepackage{Sweave}
\begin{document}
\input{math3610-02-population-growth-concordance}
...
\maxFrameImage{FIGS/slides-01-plot-census-1910-ggplot.pdf}
...
\maxFrameImage{FIGS/slides-01-plot-census-ggplot.pdf}
