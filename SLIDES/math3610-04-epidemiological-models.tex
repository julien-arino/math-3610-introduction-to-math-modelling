...
\title[Epidemic models]{MATH 3610 -- 02 \\ A few epidemic models\\ Introduction to the analysis of nonlinear systems of ordinary differential equations}
...
\usepackage{Sweave}
\begin{document}
\input{math3610-04-epidemiological-models-concordance}
