...
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs_08_genetics/dominant_hybrid}
\end{center}
\vskip0.3cm
...
\frame{\frametitle{$Gg$ and $Gg$ parents}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs_08_genetics/hybrid_hybrid}
\end{center}
\vskip0.3cm
Offspring has probability
\begin{itemize}
...
\frame{\frametitle{$gg$ and $Gg$ parents}
\begin{center}
\includegraphics[width=0.9\textwidth]{../figs_08_genetics/recessive_hybrid}
\end{center}
\vskip0.3cm
Offspring has probability
\begin{itemize}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{../figs_08_genetics/graphe_dominant}
\end{center}
Clearly: 
\begin{itemize}
...
\section{A random walk example}

\frame{\frametitle{The drunk man's walk, 1.0}
\begin{itemize}
\item chain of states $S_1,\ldots,S_p$
\item if in state $i=2,\ldots,p-1$, probability 1/2 of going left (to $i-1$) and 1/2 of going right (to $i+1$)
\item if in state $1$, probability 1 of going to 2
\item if in state $p$, probability 1 of going to $p-1$
\end{itemize}
}
