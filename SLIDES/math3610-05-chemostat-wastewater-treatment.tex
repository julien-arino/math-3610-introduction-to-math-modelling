...
\title[Chemostat]{MATH 3610 -- 05\\The chemostat -- Some notions of phase plane analysis}
...
\usepackage{Sweave}
\begin{document}
\input{math3610-05-chemostat-wastewater-treatment-concordance}
...
\begin{center}
\includegraphics[height=0.9\textheight]{FIGS/chemostat}
\end{center}
}

\frame{
\begin{center}
\includegraphics[height=0.85\textheight]{FIGS/Villefranche_sur_mer2}
\end{center}
}

\frame{
\begin{center}
\includegraphics[height=0.85\textheight]{FIGS/Villefranche_sur_mer4}
\end{center}
}

\frame{
\begin{center}
\includegraphics[height=0.85\textheight]{FIGS/Villefranche_sur_mer3}
\end{center}
}
...
\begin{center}
\includegraphics[width=\textwidth]{FIGS/monod}
\end{center}
\end{minipage}
...
\]
\begin{center}
\includegraphics[width=0.5\textwidth]{FIGS/chemo_batch_nodeath_Sx}
\end{center}
}
...
\begin{center}
\includegraphics[height=0.9\textheight]{FIGS/figchemo_eng}
\end{center}
}
...
\vskip1cm
\textbf{But} we can still use it, using the theory of \emph{asymptotically autonomous} differential equations. Too complicated for here, just remember that often, it is \emph{allowed} to use the limit of a variable rather than the variable itself, provided you know that the convergence occurs
}
