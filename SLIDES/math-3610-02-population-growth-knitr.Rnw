...
\vfill
\begin{center}
<<make-table-census-1910,echo=FALSE,results='asis'>>=
tables = list()
...
<<plot-census-1910-ggplot,eval=TRUE,echo=FALSE,fig.width=6,fig.height=4,include=FALSE>>=
library(scales)
plot_USA_census_to_1910 = 
  ggplot(USA_census_to_1910, aes(x=Year, y=Population)) +
  geom_line() +
...
<<plot-census-1910-and-fit-ggplot,eval=TRUE,echo=FALSE,fig.width=6,fig.height=4,include=FALSE>>=
plot_USA_census_to_1910 = 
  ggplot(USA_census_to_1910, aes(x=Year, y=Population)) +
...
<<plot-census-ggplot,eval=TRUE,echo=FALSE,fig.width=6,fig.height=4,include=FALSE>>=
library(scales)
plot_USA_census = 
...
<<plot-census-and-fit-ggplot,eval=TRUE,echo=FALSE,fig.width=6,fig.height=4,include=FALSE>>=
plot_USA_census = 
  ggplot(USA_census, aes(x=Year, y=Population)) +
...
<<birth-death-ODE-1,eval=TRUE,echo=FALSE,fig.width=6,fig.height=4,include=FALSE>>=
t = c(0)
N = c(1)
b = 0.1
d = 0.05
...
<<birth-death-ODE-2,eval=TRUE,echo=FALSE,fig.width=6,fig.height=4,include=FALSE>>=
...
<<plot-various-ODE,eval=TRUE,echo=FALSE,fig.width=6,fig.height=4,include=FALSE>>=
